...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.pdfModule;
 ...
 */
public class pdfModuleConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "pdfModule test case")
